...
i2v_A14B_FC = copy.deepcopy(t2v_A14B)
i2v_A14B_FC.__name__ = "Config: Wan-Fun-Control I2V A14B"
i2v_A14B_FC.in_dim = 52
i2v_A14B_FC.is_fun_control = True
